  ...
  up: async (queryInterface, Sequelize) => {
    ...
    */
    ...
    await queryInterface.bulkInsert('Products',
      ...
      // Casa felix id=1
      // Starters id=1
        { name: 'Ensaladilla', description: 'Tuna salad with mayonnaise', basePrice: 2.5, price: 2.5, image: process.env.PRODUCTS_FOLDER + '/ensaladilla.jpeg', order: 1, availability: true, restaurantId: 1, productCategoryId: 1 },
        { name: 'Olives', description: 'Home made', basePrice: 1.5, price: 1.5, image: process.env.PRODUCTS_FOLDER + '/aceitunas.jpeg', order: 2, availability: true, restaurantId: 1, productCategoryId: 1 },
